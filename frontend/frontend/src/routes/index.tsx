...
import { ArrowRight, TrendingUp, BarChart3, Sparkles, MapPin, Wallet, Bot, Building2, CheckCircle2, Activity, Layers } from "lucide-react";
...
const features = [
  ...
  { icon: MapPin, title: "Locality Insights", desc: "Deep statistics on amenities, premium scores, and growth potential by neighborhood.", to: "/locality-insights", color: "from-fuchsia-500 to-pink-500" },
  { icon: Wallet, title: "Budget Planner", desc: "EMI, stamp duty, registration, and affordability scoring in one elegant calculator.", to: "/budget-planner", color: "from-cyan-500 to-blue-500" },
  { icon: Bot, title: "AI Assistant", desc: "Chat naturally with your real estate data and receive structured visual answers.", to: "/ai-assistant", color: "from-sky-500 to-cyan-500" },
];
        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-border bg-gradient-brand p-10 text-white shadow-glow md:p-16">
          ...
          <div className="relative max-w-2xl">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link to="/ai-assistant" className="inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/10 px-6 py-3 text-sm font-semibold backdrop-blur hover:bg-white/20 transition">Ask the AI <Bot className="h-4 w-4"/></Link>
            </div>
          </div>
        </div>
      </section>
