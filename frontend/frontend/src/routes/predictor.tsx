...
const cities = ["Ahmedabad", "Mumbai", "Pune", "Bangalore", "Hyderabad", "Chennai", "Delhi", "Kolkata", "Rajkot"];
const localities = ["Shela", "Gota", "South Bopal", "Bodakdev", "Satellite", "Vastrapur", "SG Highway"];
const societies = ["Godrej Garden City", "Shaligram Lakeview", "Sun Optima", "Goyal Orchid Whitefield"];
const facilityCats = ["Standard", "Premium", "Luxury", "Ultra Luxury"];
const propertyTypes = ["Apartment", "Villa", "Penthouse", "Builder Floor"];
const sellingTypes = ["Resale", "New Booking", "Ready to Move"];

const amenities = ["Gym", "Swimming Pool", "Parking", "Power Backup", "Club House", "Security", "Garden"];
...
function Predictor() {
  ...
  const data = [
    { name: "Predicted", value: 1.38, fill: "var(--color-chart-1)" },
    { name: "Locality avg", value: 1.22, fill: "var(--color-chart-3)" },
    { name: "City avg", value: 1.05, fill: "var(--color-chart-2)" },
  ];
    ...
    <div>
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-6 py-12 lg:grid-cols-[1fr_1.05fr]">
        ...
        <div className="rounded-3xl border border-border bg-card p-6 shadow-soft animate-fade-up">
          ...
          <button onClick={()=>setPredicted(true)} className="mt-7 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-brand px-6 py-3.5 text-sm font-semibold text-white shadow-glow transition hover:scale-[1.01]">
        ...
        <div className="relative animate-fade-up">
          ...
          <div className="relative glass rounded-[2rem] p-7">
            <div className="flex items-center justify-between">
              ...
              <div className="rounded-full bg-success/20 px-3 py-1 text-xs font-semibold text-success">91% confidence</div>
            </div>
            <div className="mt-3 flex items-baseline gap-3">
              <span className="text-6xl font-bold text-gradient">₹1.38 Cr</span>
              <span className="text-sm text-muted-foreground">~₹9,517 / sqft</span>
            </div>
            <div className="mt-2 text-sm text-muted-foreground">Range: ₹1.24 Cr – ₹1.52 Cr</div>

            <div className="mt-6 grid grid-cols-2 gap-3">
              {[
                { l: "Avg locality price", v: "₹1.22 Cr", i: TrendingUp },
                { l: "Median locality price", v: "₹1.18 Cr", i: IndianRupee },
                { l: "Avg price / sqft", v: "₹8,420", i: Ruler },
                { l: "Area per bedroom", v: "483 sqft", i: Building2 },
              ].map(s => (
